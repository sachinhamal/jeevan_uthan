...
<div>
    ...
    <div align="center">
        <a  @if($user_type != 'member')href="{{route('confirmation', encrypt($token))}}" @else href="{{route('member.confirmation', encrypt($token))}}"  @endif style="font-weight: 400; display: inline-block; background-color: #428bca; color: #FFFFFF; border: 1px solid #428bca ; margin: 8px auto auto auto; padding: 12px 28px; border-radius: 2px 2px 2px 2px; text-decoration: none; outline: 0; vertical-align: middle ; line-height: 1; white-space: nowrap; text-align: center; user-select: none; --webkit-user-select: none; -moz-user-select: none; -moz-user-select: none;"> Verify Email</a>
    </div>
</div>
